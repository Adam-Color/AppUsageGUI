...
class TrackerWindow(tk.Frame):
    def __init__(self, parent, controller, logic_controller):
        ...
        pause_button = tk.Button(self, text="Pause", command=self.logic.time_tracker.pause)
        pause_button.pack(pady=5)
        resume_button = tk.Button(self, text="Resume", command=self.logic.time_tracker.resume)
    ...
    def update_time_label(self):
        ...
        while not self.stop_event.is_set():
            ...
            # start the tracking
            if self.app and not self.logic.time_tracker.is_running():
            ...
            if self.logic.time_tracker.is_running() and self.app not in app_names and self.logic.file_handler.get_continuing_tracker() is False:
